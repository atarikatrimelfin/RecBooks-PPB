...
const Books = () => {
    ...
    useEffect (() => {
        const fetchBooks = async () => {
            const res = await axios.get("https://api.nytimes.com/svc/books/v3/lists/2022-10-11/hardcover-fiction.json?api-key=KFvtzEOG5gyvdiTyzOJ1QqswfdYM96NR")
    ...
    return (
        <>
        <div>
            <h1 id="pageTitle">Past Reccomendation</h1>
